...
* Return: no return
*/
void_div(stack_t **doubly, unsigned int cline)
{
int m = 0;
stack_t *aux = NULL;
...
* Return: no return
*/
void_mul(stack_t **doubly, unsigned int cline)
{
int m = 0;
stack_t *aux = NULL;
...
* Return: no return
*/
void_mod(stack_t **doubly, unsigned int cline)
{
int m = 0;
stack_t *aux = NULL;
...
* @doubly: head of the linked lis@cline: line number;
* Return: no return
*/
void_pchar(stack_t **doubly, unsigned int cline)
{
...
* Return: no return
*/
void_pstr(stack_t **doubly, unsigned int cline)
{
stack_t *aux;
(void)cline;
